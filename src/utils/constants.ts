...
export const Devs = /* #__PURE__*/ Object.freeze({
    ...
    Goonie: {
        name: "Goonie",
        id: 953028580043018281n
    },
    Ben: {
        name: "Ben",
        id: 948040864725352479n
    },
    Calcifer: {
        name: "Calcifer",
        id: 789539263682576425n
    }
} satisfies Record<string, Dev>);

export const UxxCordDevs = Object.freeze({
    kaian: {
        name: "Kaian",
        id: 856547618674573313n
    },
    ...
    Jay: {
        name: "Jay",
        id: 1242570396771946578n
    }
} satisfies Record<string, Dev>);

export const OwnerDevs = Object.freeze({
    kaian: {
        name: "Kaian",
        id: 856547618674573313n
    },
...
export const Amara = Object.freeze({
    Amara: {
        name: "Amara",
        id: 905428118012055575n
    }
...
export const Jay = Object.freeze({
    Jay: {
        name: "Jay",
        id: 1242570396771946578n
    }
...
export const UxxCordDevsById = /* #__PURE__*/ (() =>
    Object.freeze(Object.fromEntries(
        Object.entries(UxxCordDevs)
            .filter(d => d[1].id !== 0n)
            .map(([_, v]) => [v.id, v] as const)
    ))
)() as Record<string, Dev>;

export const OwnerDevsById = /* #__PURE__*/ (() =>
    Object.freeze(Object.fromEntries(
        Object.entries(OwnerDevs)
            .filter(d => d[1].id !== 0n)
            .map(([_, v]) => [v.id, v] as const)
    ))
)() as Record<string, Dev>;

export const AmaraById = /* #__PURE__*/ (() =>
    Object.freeze(Object.fromEntries(
        Object.entries(Amara)
            .filter(d => d[1].id !== 0n)
            .map(([_, v]) => [v.id, v] as const)
    ))
)() as Record<string, Dev>;

export const BenById = /* #__PURE__*/ (() =>
    Object.freeze(Object.fromEntries(
        Object.entries(Ben)
            .filter(d => d[1].id !== 0n)
            .map(([_, v]) => [v.id, v] as const)
...
export const SakuraById = /* #__PURE__*/ (() =>
    Object.freeze(Object.fromEntries(
        Object.entries(Sakura)
            .filter(d => d[1].id !== 0n)
            .map(([_, v]) => [v.id, v] as const)
    ))
)() as Record<string, Dev>;
