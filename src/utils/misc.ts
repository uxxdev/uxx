...
import { UxxCordDevsById, DevsById, OwnerDevsById, AmaraById, BenById, JayById, SakuraById } from "./constants";
...
export const isUxxCordPluginDev = (id: string) => Object.hasOwn(UxxCordDevsById, id);
export const isOwnerPluginDev = (id: string) => Object.hasOwn(OwnerDevsById, id);
export const isAmara = (id: string) => Object.hasOwn(AmaraById, id);
export const isBen = (id: string) => Object.hasOwn(BenById, id);
export const isJay = (id: string) => Object.hasOwn(JayById, id);
export const isSakura = (id: string) => Object.hasOwn(SakuraById, id);
