...
const DEFAULT_DONATE_IMAGE = "https://files.catbox.moe/izywc1.gif";
const SHIGGY_DONATE_IMAGE = "https://files.catbox.moe/izywc1.gif";
...
function VencordSettings() {
    ...
    return (
        <SettingsTab title="UxxCord Settings">
    ...
    return (
        <Card className={cl("card", "donate")}>
            <div>
                ...
                <Forms.FormText>discord.gg/uxx</Forms.FormText>
...
export default wrapTab(VencordSettings, "UxxCord Settings");
